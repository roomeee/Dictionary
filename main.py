...
def Lookup():
    ...
    try:
        ...
        if explanation:
            ...
            text.insert(END, f"Word '{word}' not found in the dictionary.", 'error')
...
button = ctk.CTkButton(frame, text="Look up", command=Lookup)
...
text = Text(text_frame, width=68, height=20, bd=0, wrap=WORD, bg='#292929', fg='white', font=('Arial', 12), yscrollcommand=scrollbar.set)
